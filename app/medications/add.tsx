...
export default function AddMedicationScreen() {
  ...
  try {
    ...
    const medicineData = {
      ...
      schedule: form.times,
      notes: form.notes,
      quantity: form.currentSupply ? Number(form.currentSupply) : 0,
      refillAlertAt: form.refillAt ? Number(form.refillAt) : 5,
    };
    ...
    const errorMessage = error?.message || 'Failed to save medication';
